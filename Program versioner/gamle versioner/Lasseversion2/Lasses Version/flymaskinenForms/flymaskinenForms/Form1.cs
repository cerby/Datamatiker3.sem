...
namespace flymaskinenForms
{
    public partial class Form1 : Form
    {
        ...
        public void Encrypt()
        {
            ...
            encrypted = trans.TransformFinalBlock(utf8.GetBytes(comboBoxBy1.Text), 0,
                utf8.GetBytes(comboBoxBy1.Text).Length);
        }
        ...
        public void Decrypt()
        {
           ...
           // MessageBox.Show(utf8.GetString(trans.TransformFinalBlock(encrypted, 0, encrypted.Length)));
            comboBoxBy1.Text =utf8.GetString(trans.TransformFinalBlock(encrypted, 0, encrypted.Length));
