            ...
            try
            {
                while (true)
                {
                    for (int i = 0; i <= graf.byliste.Count * (graf.byliste.Count - 1); i++)
                    {
                        ...
                        CHAfbudsdata = graf.SetAfbudsPris();
                        SendMessage(CHAfbudsdata);
                        Console.WriteLine(CHAfbudsdata);
                        Thread.Sleep(5000);

                        CHFjernData = graf.FjernForbindelse();
                        SendMessage(CHFjernData);
                        Console.WriteLine(CHFjernData);
                        Thread.Sleep(5000);
