...
namespace Flyrejsesøgemaskine_version_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            graf.FjernForbindelse(1,2);
           // graf.FindBilligsteRute("London","Paris");
            Console.WriteLine("-----");
            graf.udskrivForbindelser();
        }
    }
    class Graph
    {
        ...
        public void FjernForbindelse(int a, int b)
        {
            bool tjek = true;
            ...
            while (byliste[a].ruteliste[b] == null)
            {
                a = random.Next(0, 8);
                b = random.Next(0, 8);
